...
function MainPage() {
    return (
        <div className="flex w-full flex-col items-center bg-white transition delay-1000 duration-1000 ease-in-out">
            <section className="my-28 flex w-full max-w-screen-xl flex-row ">
                <div className="flex w-1/2 flex-col items-start gap-y-7  p-4">
                    ...
                    <p className="w-2/3 text-lg font-medium text-black">
                        Centralize your team’s knowledge and create beautiful
                        documentation your customers and teams will love
                    </p>
                    <div>
                        <Link
                            href={ROUTES.AUTH}
                            className="group flex w-fit flex-row items-center justify-center gap-x-2 rounded py-2 text-black  hover:scale-105 ">
                            <div className="rounded-full bg-black bg-primary p-2">
